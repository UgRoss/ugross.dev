...
date: '2020-12-04'
description: A Stack is a linear data structure that keeps its elements stacked on each other. It uses LIFO (last-in-first-out) ordering in which the last pushed item to the stack is processed first.
image: ./stack.jpeg
tags: ['datastructures']
---
