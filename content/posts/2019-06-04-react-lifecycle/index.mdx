...
<Alert type="info">
  <p>
    In the current phase (mounting) it's also possible to use the <code>constructor</code> instead
    of this method.
  </p>
</Alert>
...
<Alert type="info">
  <p>
    ...
    <code>render()</code> method to be pure (it doesn't modify the state, doesn't directly interact
    with the browser, and returns the same result for the same props and state).
  </p>
</Alert>
